"""
Django settings for nurture_buddy_46401 project.
...
ROOT_URLCONF = 'nurture_buddy_46401.urls'
...
WSGI_APPLICATION = 'nurture_buddy_46401.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nurture_buddy_46401 API",
    "DESCRIPTION": "API documentation for nurture_buddy_46401 App",
    "VERSION": "v1",
}
